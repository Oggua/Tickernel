...
function tknRenderPipeline.setup(pGfxContext, assetsPath, pMeshVertexInputLayout, pInstanceVertexInputLayout, renderPassIndex)
    ...
    local pAttachments = {tknRenderPipeline.pDepthAttachment, tknRenderPipeline.pAlbedoAttachment, tknRenderPipeline.pNormalAttachment, tknRenderPipeline.pSwapchainAttachment}

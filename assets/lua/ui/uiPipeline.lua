...
function uiPipeline.createPipelinePtr(pTknGfxContext, pTknRenderPass, subpassIndex, assetsPath, pUIVertexInputLayout)
...
function uiPipeline.destroyPipelinePtr(pTknGfxContext, pTknPipeline)
